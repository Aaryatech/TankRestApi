...
@Entity
public class GetCustomerLocName {
	@Id
	...
	public String toString() {
		return "GetCustomerLocName [customerId=" + customerId + ", customerName=" + customerName + ", customerAddress="
				...
				+ ", exVar3=" + exVar3 + ", exFloat1=" + exFloat1 + ", remark=" + remark + ", locationName="
				+ locationName + "]";
	}
