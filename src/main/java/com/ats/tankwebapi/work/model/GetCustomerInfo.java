...
public class GetCustomerInfo {
	...
	public String toString() {
		return "GetCustomerInfo [customerId=" + customerId + ", customerName=" + customerName + ", customerAddress="
				...
				+ ", exVar3=" + exVar3 + ", exFloat1=" + exFloat1 + ", remark=" + remark + ", paymentDate="
				+ paymentDate + ", costRs=" + costRs + ", workDate=" + workDate + ", totalAmt=" + totalAmt + "]";
	}
